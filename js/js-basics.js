...
// FOR ([DEF indice] ; [ALCANCE o Cond Verdadero]; [MOD indice]) {}
console.log("START");
var rechazados = [];
for (var i in list) {
  console.log(i);
...
var d = new Date("2020/04/25 15:05:00.000");
console.log(d);

console.log(listaPersonas.sort((a, b) => a.edad - b.edad));

var sortedArr = [0,3,5,7,1,6,9];
console.log(sortedArr);
var sVal = sortedArr.shift();
console.log(sVal);
console.log(sortedArr);
sortedArr.unshift(sVal);
console.log(sortedArr);
sortedArr.splice(2, 2);
console.log(sortedArr);
sortedArr.splice(2, 2, 99, 8, 9, "pepe");
console.log(sortedArr);
...
function nombre(n, a, p) {
  return n + " " + a;
}

function calle(a, b, c, d, e) {
  pais = calcPais(c)
...
function saludar(usuario) {
  console.log("Hola " + nombre(usuario.n, usuario.a));
}

saludar("Fede", "Vittorini");
